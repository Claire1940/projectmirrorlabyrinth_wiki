...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Project Mirror Labyrinth Wiki",
    description: "Read the Terms of Service for Project Mirror Labyrinth Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Project Mirror Labyrinth Wiki",
      description: "Terms and conditions for using Project Mirror Labyrinth Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Project Mirror Labyrinth Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Project Mirror Labyrinth Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Project Mirror Labyrinth Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Project Mirror Labyrinth Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Project Mirror Labyrinth". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Project Mirror Labyrinth Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Project Mirror Labyrinth. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Project Mirror Labyrinth Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Project Mirror Labyrinth. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Game content, codes, and balance updates may change without notice as Project Mirror Labyrinth is regularly patched. We are not responsible for in-game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, PROJECT MIRROR LABYRINTH WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Project Mirror Labyrinth Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@projectmirrorlabyrinth.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@projectmirrorlabyrinth.wiki</a>
            </p>
            <p>
